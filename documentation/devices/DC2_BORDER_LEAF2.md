...
| --------- | ----------- | -----| ------------- | ---------- | ----| ---- | -------- | ------ | ------- |
| Ethernet1 | P2P_LINK_TO_DC2_SPINE1_Ethernet6 | routed | - | 172.31.20.145/31 | default | 9214 | False | - | - |
| Ethernet2 | P2P_LINK_TO_DC2_SPINE2_Ethernet6 | routed | - | 172.31.20.147/31 | default | 9214 | False | - | - |
| Ethernet3 | P2P_LINK_TO_DC2_SPINE3_Ethernet6 | routed | - | 172.31.20.149/31 | default | 9214 | False | - | - |
...
| 172.31.20.144 | 65200 | default | - | Inherited from peer group IPv4-UNDERLAY-PEERS | Inherited from peer group IPv4-UNDERLAY-PEERS | - | - | - | - | - | - |
| 172.31.20.146 | 65200 | default | - | Inherited from peer group IPv4-UNDERLAY-PEERS | Inherited from peer group IPv4-UNDERLAY-PEERS | - | - | - | - | - | - |
| 172.31.20.148 | 65200 | default | - | Inherited from peer group IPv4-UNDERLAY-PEERS | Inherited from peer group IPv4-UNDERLAY-PEERS | - | - | - | - | - | - |
...
| ---- | ------------------- | ----------------- | ------------------- | ------------------- | ------------ |
| 111 | 10.255.20.25:10111 | 10111:10111<br>remote 10111:10111 | - | - | learned |
| 112 | 10.255.20.25:10112 | 10112:10112<br>remote 10112:10112 | - | - | learned |
...
router bgp 65222
   ...
   neighbor 172.31.20.144 peer group IPv4-UNDERLAY-PEERS
   neighbor 172.31.20.144 remote-as 65200
   neighbor 172.31.20.144 description DC2_SPINE1_Ethernet6
   neighbor 172.31.20.146 peer group IPv4-UNDERLAY-PEERS
   neighbor 172.31.20.146 remote-as 65200
   neighbor 172.31.20.146 description DC2_SPINE2_Ethernet6
   neighbor 172.31.20.148 peer group IPv4-UNDERLAY-PEERS
   neighbor 172.31.20.148 remote-as 65200
   neighbor 172.31.20.148 description DC2_SPINE3_Ethernet6
   redistribute connected route-map RM-CONN-2-BGP
   !
   vlan 111
      rd 10.255.20.25:10111
      rd evpn domain remote 10.255.20.25:10111
   ...
   vlan 112
      ...
      rd evpn domain remote 10.255.20.25:10112
